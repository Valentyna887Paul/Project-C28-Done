  ...
  for (var i = 0; i < playerArrows.length; i++) {
    if (playerArrows[i] !== undefined) {
     ...
     if (board1Collision.collided || board2Collision.collided) {
      ...
      // Bianca, estou positiva que é o acima, mas acredito que esta tendo algum problema com o codigo.
      // O codigo devia estar fazendo com que apontuação das duas miras estarem subindo quando tem...
      // colizão com flexas, mas por algun motivo isso não esta contecendo com a board2Collision... Só a board1Collision.
